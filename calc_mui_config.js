...
const AlertDialog = () => {
    ...
    return ((0,jsx_runtime.jsxs)(Dialog_Dialog, { open: openAlert, onClose: closeAlert, "aria-labelledby": "alert-dialog-title", "aria-describedby": "alert-dialog-description", children: [(0,jsx_runtime.jsx)(DialogTitle_DialogTitle, { id: "alert-dialog-title", children: alertTitle }), (0,jsx_runtime.jsx)(DialogContent_DialogContent, { children: (0,jsx_runtime.jsx)(DialogContentText_DialogContentText, { id: "alert-dialog-description", style: { wordBreak: "break-word", whiteSpace: "pre-line" }, children: alertText }) }), (0,jsx_runtime.jsxs)(DialogActions_DialogActions, { children: [showCopy && (0,jsx_runtime.jsx)(Button_Button, { onClick: copyText, children: crL10N["copy"] || "Copy" }), (0,jsx_runtime.jsx)(Button_Button, { onClick: closeAlert, autoFocus: true, children: crL10N["ok"] || "OK" })] })] }));
};
const OptionDialog = () => {
    const [openAlert, setOpenAlert] = react.useState(false);

...
/* harmony import */ var _emotion_serialize__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(3114);
...
// EXTERNAL MODULE: ../node_modules/@mui/utils/esm/deepmerge/deepmerge.js
var calc_mui_deepmerge = __webpack_require__(6121);
// EXTERNAL MODULE: ../node_modules/@mui/system/esm/styleFunctionSx/defaultSxConfig.js + 5 modules
var defaultSxConfig = __webpack_require__(8624);
// EXTERNAL MODULE: ../node_modules/@mui/system/esm/styleFunctionSx/styleFunctionSx.js
var styleFunctionSx = __webpack_require__(2927);
...
{}
  ...
  if (false) // removed by dead control flow
{}
  const paletteOutput = (0,calc_mui_deepmerge/* default */.A)((0,esm_extends/* default */.A)({
...
{}
  ...
  return (0,calc_mui_deepmerge/* default */.A)((0,esm_extends/* default */.A)({
    htmlFontSize,
    pxToRem,
    fontFamily,
    fontSize,
...
function createTheme_createTheme(options = {}, ...args) {
  ...
  let muiTheme = (0,calc_mui_deepmerge/* default */.A)(systemTheme, {
  ...
  muiTheme = (0,calc_mui_deepmerge/* default */.A)(muiTheme, other);
  muiTheme = args.reduce((acc, argument) => (0,calc_mui_deepmerge/* default */.A)(acc, argument), muiTheme);
  if (false) // removed by dead control flow
{}
  muiTheme.unstable_sxConfig = (0,esm_extends/* default */.A)({}, defaultSxConfig/* default */.A, other == null ? void 0 : other.unstable_sxConfig);
  muiTheme.unstable_sx = function sx(props) {
...
const calc_mui_ThemeContext = /*#__PURE__*/react.createContext(null);
if (false) // removed by dead control flow
{}
/* harmony default export */ const useTheme_ThemeContext = (calc_mui_ThemeContext);
...
var styled_engine = __webpack_require__(7715);
// EXTERNAL MODULE: ../node_modules/@mui/styled-engine/GlobalStyles/GlobalStyles.js
var GlobalStyles = __webpack_require__(1928);
...
function getRadioGroupUtilityClass(slot) {
  return generateUtilityClass_generateUtilityClass('MuiRadioGroup', slot);
}
...
const AlertDialog = () => {
    ...
    const showAlert = react.useCallback((title, text, showCopy) => {
    ...
    react.useEffect(() => {
        window.calcMuiPlugin.showAlert = showAlert;
        const hashChange = () => {
        ...
        return () => {
            window.calcMuiPlugin.showAlert = undefined;
            removeEventListener("hashchange", hashChange);
        };
    }, [openAlert]);
    return ((0,jsx_runtime.jsxs)(Dialog_Dialog, { open: openAlert, onClose: closeAlert, "aria-labelledby": "alert-dialog-title", "aria-describedby": "alert-dialog-description", children: [(0,jsx_runtime.jsx)(DialogTitle_DialogTitle, { id: "alert-dialog-title", children: alertTitle }), (0,jsx_runtime.jsx)(DialogContent_DialogContent, { children: (0,jsx_runtime.jsx)(DialogContentText_DialogContentText, { ref: contentRef, id: "alert-dialog-description", style: { wordBreak: "break-word", whiteSpace: "pre-line" }, children: alertText }) }), (0,jsx_runtime.jsxs)(DialogActions_DialogActions, { children: [showCopy && (0,jsx_runtime.jsx)(Button_Button, { onClick: copyText, children: crL10N["copy"] || "Copy" }), (0,jsx_runtime.jsx)(Button_Button, { onClick: closeAlert, autoFocus: true, children: crL10N["ok"] || "OK" })] })] }));
};
const OptionDialog = () => {
    const [openAlert, setOpenAlert] = react.useState(false);
    ...
    const showAlert = react.useCallback((showExact) => {
    ...
    if (CONFIG_UI_SAVE_RESULT) {
        react.useEffect(() => {
            window.calcMuiPlugin.showSaveOption = showAlert;
            const hashChange = () => {
            ...
            addEventListener("hashchange", hashChange);
            return () => {
                window.calcMuiPlugin.showSaveOption = undefined;
                removeEventListener("hashchange", hashChange);
            };
        }, [openAlert]);
    }
    const handleClick = react.useCallback((event) => {
        if (calc_mui_plugin.onSaveClick)
            calc_mui_plugin.onSaveClick(event.target.value);
        closeAlert();
    }, []);
    return ((0,jsx_runtime.jsxs)(Dialog_Dialog, { open: openAlert, onClose: closeAlert, "aria-labelledby": "alert-dialog-title", "aria-describedby": "alert-dialog-description", children: [(0,jsx_runtime.jsx)(DialogTitle_DialogTitle, { id: "alert-dialog-title", children: crL10N["saveResult"] || "Save Result" }), (0,jsx_runtime.jsx)(DialogContent_DialogContent, { children: (0,jsx_runtime.jsxs)(RadioGroup_RadioGroup, { id: "alert-dialog-description", children: [(0,jsx_runtime.jsx)(Button_Button, { color: "secondary", value: "choose", sx: buttonHiddenStyle, onClick: handleClick, children: crL10N["chooseOption"] || "Choose Option" }), (0,jsx_runtime.jsx)(Button_Button, { color: "secondary", value: "exact", sx: showExact ? buttonStyle : buttonHiddenStyle, onClick: handleClick, children: crL10N["exactSave"] || "Save Exact Result" }), (0,jsx_runtime.jsx)(Button_Button, { color: "secondary", value: "truncated", sx: buttonStyle, onClick: handleClick, children: crL10N["truncatedSave"] || "Save Truncated Result" }), (0,jsx_runtime.jsx)(Button_Button, { color: "secondary", value: "integer", sx: buttonStyle, onClick: handleClick, children: crL10N["integerSave"] || "Save Integer Part" })] }) }), (0,jsx_runtime.jsx)(DialogActions_DialogActions, { children: (0,jsx_runtime.jsx)(Button_Button, { onClick: closeAlert, children: crL10N["cancel"] || "Cancel" }) })] }));
};
const DialogApp = () => {
    const theme = react.useMemo(() => styles_createTheme(themeProps), []);
    return ((0,jsx_runtime.jsx)(react.StrictMode, { children: (0,jsx_runtime.jsx)(StyledEngineProvider/* default */.A, { injectFirst: true, children: (0,jsx_runtime.jsxs)(styles_ThemeProvider_ThemeProvider, { theme: theme, children: [(0,jsx_runtime.jsx)(AlertDialog, {}), CONFIG_UI_SAVE_RESULT && (0,jsx_runtime.jsx)(OptionDialog, {})] }) }) }));
};
const ButtonApp = ({ text, click, disabled }) => {
    const theme = react.useMemo(() => styles_createTheme(themeProps), []);
    return ((0,jsx_runtime.jsx)(react.StrictMode, { children: (0,jsx_runtime.jsx)(StyledEngineProvider/* default */.A, { injectFirst: true, children: (0,jsx_runtime.jsx)(styles_ThemeProvider_ThemeProvider, { theme: theme, children: (0,jsx_runtime.jsx)(Button_Button, { variant: "outlined", disabled: disabled, disableElevation: true, onClick: click, style: { borderRadius: "0", padding: "0", width: "100%", height: "1.5em", fontSize: "1em", textTransform: "none" }, children: text }) }) }) }));
};
const SimplifyButtonApp = ({ click }) => {
    const theme = react.useMemo(() => styles_createTheme(themeProps), []);
    return ((0,jsx_runtime.jsx)(react.StrictMode, { children: (0,jsx_runtime.jsx)(StyledEngineProvider/* default */.A, { injectFirst: true, children: (0,jsx_runtime.jsx)(styles_ThemeProvider_ThemeProvider, { theme: theme, children: (0,jsx_runtime.jsx)(Button_Button, { onClick: click, style: { width: "100%", height: "100%", fontSize: "1em", minWidth: "0", padding: "0" }, children: (0,jsx_runtime.jsx)("img", { alt: "Show simplified result", src: "simplify.svg" }) }) }) }) }));
};
const HypButtonApp = ({ plugin }) => {
    ...
    return show ? ((0,jsx_runtime.jsx)(ButtonApp, { text: "HYP", click: click })) : ((0,jsx_runtime.jsx)("button", { style: { width: "100%", height: "100%", fontSize: "1em", minWidth: "0" }, onClick: click, children: "HYP" }));
};
if (!window.calcMuiPlugin) {
    window.calcMuiPlugin = {};
}
const calc_mui_plugin = window.calcMuiPlugin;
const getElementById = document.getElementById.bind(document);
const reactRoot = getElementById("react-root");
client.createRoot(reactRoot).render((0,jsx_runtime.jsx)(DialogApp, {}));
if (CONFIG_FUNCTION_PANEL && CONFIG_SW_HYP && reactRoot.dataset.hyp === "true") {
    client.createRoot(getElementById("react_hyp_root")).render((0,jsx_runtime.jsx)(HypButtonApp, { plugin: calc_mui_plugin }));
    client.createRoot(getElementById("react_sinh_root")).render((0,jsx_runtime.jsx)(ButtonApp, { disabled: !CONFIG_HYP, text: CONFIG_HYP ? "sinh" : "", click: () => { calc_mui_plugin.onSinhButtonClick && calc_mui_plugin.onSinhButtonClick(); } }));
    client.createRoot(getElementById("react_cosh_root")).render((0,jsx_runtime.jsx)(ButtonApp, { disabled: !CONFIG_HYP, text: CONFIG_HYP ? "cosh" : "", click: () => { calc_mui_plugin.onCoshButtonClick && calc_mui_plugin.onCoshButtonClick(); } }));
    client.createRoot(getElementById("react_tanh_root")).render((0,jsx_runtime.jsx)(ButtonApp, { disabled: !CONFIG_HYP, text: CONFIG_HYP ? "tanh" : "", click: () => { calc_mui_plugin.onTanhButtonClick && calc_mui_plugin.onTanhButtonClick(); } }));
    client.createRoot(getElementById("react_asinh_root")).render((0,jsx_runtime.jsx)(ButtonApp, { disabled: !CONFIG_HYP_INV, text: CONFIG_HYP_INV ? "asinh" : "", click: () => { calc_mui_plugin.onASinhButtonClick && calc_mui_plugin.onASinhButtonClick(); } }));
    client.createRoot(getElementById("react_acosh_root")).render((0,jsx_runtime.jsx)(ButtonApp, { disabled: !CONFIG_HYP_INV, text: CONFIG_HYP_INV ? "acosh" : "", click: () => { calc_mui_plugin.onACoshButtonClick && calc_mui_plugin.onACoshButtonClick(); } }));
    client.createRoot(getElementById("react_atanh_root")).render((0,jsx_runtime.jsx)(ButtonApp, { disabled: !CONFIG_HYP_INV, text: CONFIG_HYP_INV ? "atanh" : "", click: () => { calc_mui_plugin.onATanhButtonClick && calc_mui_plugin.onATanhButtonClick(); } }));
    postMessage("hypRendered");
}
if (CONFIG_UI_SIMPLIFY && reactRoot.dataset.simp === "true") {
    const link = getElementById("show_simplify");
    client.createRoot(getElementById("react_simplify_root")).render((0,jsx_runtime.jsx)(SimplifyButtonApp, { click: () => link.click() }));
